											...
											<div class="card-block">
												<form action="/admin/add-product" method="post"
													...
													<div class="row">
														<div class="col-md-4 text-center">
															<label for="thumbnail" class="border border-primary mt-2"
																...
																<img src="/assets/images/no_image.jpg" id="imagePreview"
																class="over " />
														...
														<div class="col-md-8">
															<div class="form-group form-primary">
																...
																<span class="form-bar"></span> <label
																	class="float-label">Product Name</label>
															</div>
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group form-primary">
																		<select type="text" name="categoryId" id="category"
																			...
																			class="float-label">Category</label>
																	</div>
																</div>
																<div class="col-sm-6">
																	<div class="form-group form-primary">
																		...
																		<span class="form-bar"></span> <label
																			class="float-label">Slug Product</label>
																	</div>
																</div>
															</div>
															<div class="row">
															...
															<div class="form-group form-primary">
																...
																<span class="form-bar"></span> <label
																	class="float-label">Description</label>
															</div>
														</div>
													</div>
																...
																<div class="col-12 row px-5 mt-3 mb-4 text-left">
																	...
																	<div class="col-sm-3 px-0">
																		<input type="text" name="hex1"
																			class="form-control hex" onfocus="clickHex(this)"
													...
													<div class="mt-3 row">
														...
														<div class="col-sm-8">
															<button class="btn btn-primary w-100 font-weight-bold">Submit
																Form</button>
														</div>
													</div>
												</form>
